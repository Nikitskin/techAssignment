Requirements:
You should have dotnet core 2.1 installed.

To run test:
You can trigger Runbatch.cmd file.
Cmd file will, get nuget packages, build solution with dotnet build command and then will trigger dotnet test which will generate reports.
